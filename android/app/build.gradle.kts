...
// Keystore de release (android/upload-keystore.jks + android/key.properties, ambos fora do git).
// Sem key.properties o release cai na chave de debug, so pra `flutter run --release` em maquina
// nova; o release.ps1 recusa publicar APK assinado com debug.
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.truckrouter.truck_router"
